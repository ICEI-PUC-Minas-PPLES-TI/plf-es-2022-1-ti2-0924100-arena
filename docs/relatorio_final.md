...
## 3.2. Descrição Geral da proposta
  ...
  Para utilizar a  ferramenta Arena, o usuário deverá se cadastrar informando dados relevantes como nome, CPF e os esportes que deseja jogar. Após o registro, plataforma disponibilizará meios para: </br> </br>
